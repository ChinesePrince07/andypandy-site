...
const LINKEDIN = "https://www.linkedin.com/in/andy-zhang-3a280135a/";
...
export default function Footer() {
  ...
  return (
    <footer className="mono flex flex-col gap-2 border-t-[3px] border-double border-rule px-4 py-3 text-[9.5px] uppercase tracking-[0.14em] text-faint sm:flex-row sm:items-center sm:justify-between sm:px-11 sm:py-2">
